...
public class TelaMarcas {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaMarcas window = new TelaMarcas();
	...
	private void initialize() {
		...
		panel_2.setBounds(244, 197, 700, 150);
		frame.getContentPane().add(panel_2);
		panel_2.setLayout(null);
		
		JLabel lblNewLabel_1_2 = new JLabel("Marca 1");
		...
		JLabel lblNewLabel_2_1 = new JLabel("Marcas parceiras");
		lblNewLabel_2_1.setBounds(244, 143, 253, 43);
		...
		panel_2_1.setBounds(244, 377, 700, 150);
		frame.getContentPane().add(panel_2_1);
		
		JLabel lblNewLabel_1_2_1 = new JLabel("Marca 2");
		...
		panel_2_2.setBounds(244, 560, 700, 150);
		frame.getContentPane().add(panel_2_2);
		
		JLabel lblNewLabel_1_2_2 = new JLabel("Marca 3");
